...
class ATSSKDTrainer(object):
    ...
    def train(self, epoch, data_loader_target, optimizer, disc_optimizer, 
                weight=0.5, weight_ms=3, weight_tf=1.5, pose_reid_weight=0.5, cam_reid_weight=0.5, print_freq=1, train_iters=200):
        self.model_1.train()
        self.model_2.train()
        self.model_3.train()
        self.model_1_ema.train()
        ...
        for i in range(train_iters):
            ...
            # process inputs
            inputs_1, inputs_2, inputs_3, targets, c_org, p_org = self._parse_data(target_inputs)
